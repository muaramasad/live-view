...
D:/JAPFA/laragonginx/ffmpg/bin/ffmpeg -rtsp_transport tcp -i rtsp://admin:FIW170845@10.21.113.113:554/stream=0.sdp -vf scale=844:480 -r 1/1 -t 120 D:/JAPFA/laragonginx/www/cctv/public/video/1/ip-%01d.jpeg

#Delete previous taken snapshots older than 7 days
find D:/JAPFA/laragonginx/www/cctv/public/video/1/ -name '*.jpeg' -mmin +1 -delete
