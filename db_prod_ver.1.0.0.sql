...
-- Membuang data untuk tabel cctv_app_ver_1_0.cams: ~47 rows (lebih kurang)
...
INSERT INTO `cams` (`id`, `cam_name`, `cam_ip_address`, `cam_file_path`, `cam_cor_x`, `cam_cor_y`, `site_id`, `created_at`, `updated_at`) VALUES
	...
	(48, 'Gerbang Utama', '10.21.101.150', 'test', '-6.6413271719670695', '107.5574071462097', 7, '2018-03-06 02:27:59', '2018-03-06 02:27:59'),
	...
	(51, 'Fumigasi 1', '10.21.102.113', NULL, '-6.628842524092458', '107.52289248060606', 6, '2018-03-07 06:48:57', '2018-03-07 06:48:57'),
...
-- Membuang data untuk tabel cctv_app_ver_1_0.migrations: ~14 rows (lebih kurang)
...
-- Membuang data untuk tabel cctv_app_ver_1_0.permissions: ~4 rows (lebih kurang)
...
-- Membuang data untuk tabel cctv_app_ver_1_0.permission_role: ~0 rows (lebih kurang)
...
-- Membuang data untuk tabel cctv_app_ver_1_0.roles: ~2 rows (lebih kurang)
...
-- Membuang data untuk tabel cctv_app_ver_1_0.role_user: ~0 rows (lebih kurang)
...
INSERT INTO `sites` (`id`, `site_name`, `cor_x`, `cor_y`, `url_1`, `url_2`, `area_id`, `created_at`, `updated_at`, `division_id`) VALUES
	(1, 'Wanayasa 4', '-6.627321376421916', '107.55490501376653', 'http://test.com', NULL, 1, '2018-01-22 08:37:19', '2018-03-05 09:39:32', 1),
...
-- Membuang data untuk tabel cctv_app_ver_1_0.users: ~1 rows (lebih kurang)
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
INSERT INTO `users` (`id`, `name`, `email`, `password`, `remember_token`, `created_at`, `updated_at`) VALUES
	(1, 'Administrator', 'admin@japfa.com', '$2y$10$hfkxtjzophFYq/dxBYcUi.4LTIYdnW49lI/oGdoO4i9PQQcTo9xFm', 'TGkMsz2E6F3G7B5GxAIfmLSJz635X2j6bpOUGSDlWRzkx5ABaPSTd0J4hPEq', '2018-02-23 07:36:53', '2018-02-23 07:36:53'),
	(2, 'User', 'user@japfa.com', '$2y$10$Pp.Q35cDd1v4PsQqaznYyOOM/lbN36M6nj8I1DHGcMK2wSbZMLHK6', 'oLbSLd0yTuZ4S9pogKEGTzdRdBNM6xllNtm9Is7actemqbWXjgriTobUcDxU', '2018-03-02 08:02:39', '2018-03-02 08:02:39');
/*!40000 ALTER TABLE `users` ENABLE KEYS */;

-- membuang struktur untuk table cctv_app_ver_1_0.user_area
...
-- Membuang data untuk tabel cctv_app_ver_1_0.user_area: ~0 rows (lebih kurang)
/*!40000 ALTER TABLE `user_area` DISABLE KEYS */;
/*!40000 ALTER TABLE `user_area` ENABLE KEYS */;

-- membuang struktur untuk table cctv_app_ver_1_0.user_division
...
-- Membuang data untuk tabel cctv_app_ver_1_0.user_division: ~0 rows (lebih kurang)
/*!40000 ALTER TABLE `user_division` DISABLE KEYS */;
/*!40000 ALTER TABLE `user_division` ENABLE KEYS */;

-- membuang struktur untuk table cctv_app_ver_1_0.user_site
...
-- Membuang data untuk tabel cctv_app_ver_1_0.user_site: ~0 rows (lebih kurang)
